...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = "https://api.locationiq.com/v1/autocomplete?key=pk.c45e9660515738aeb1eedfaccd16e9b2&limit=5&dedupe=1&"
  ...
  return (
    <Box>
        ...
        helperText = {fieldState.error
            ? fieldState.error.message || "Please select a location from the suggestions"
            : undefined}
        /> 
